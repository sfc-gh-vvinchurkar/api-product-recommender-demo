...
CREATE DATABASE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER
    COMMENT = 'Product Recommender PoC for Australian Pharmaceutical Industries';

-- Create Schemas
CREATE SCHEMA IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.RAW 
    COMMENT = 'Raw ingested data';
CREATE SCHEMA IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.STAGING 
    COMMENT = 'Cleaned and validated data';
CREATE SCHEMA IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.FEATURES 
    COMMENT = 'ML feature engineering';
CREATE SCHEMA IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.ML 
    COMMENT = 'ML models and predictions';
CREATE SCHEMA IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.ANALYTICS 
    COMMENT = 'Semantic models and dashboards';
CREATE SCHEMA IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.GOVERNANCE 
...
CREATE STAGE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.ANALYTICS.SEMANTIC_MODELS
...
CREATE TABLE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.RAW.RAW_MEMBERS (
...
CREATE TABLE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.RAW.RAW_PRODUCTS (
...
CREATE TABLE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.RAW.RAW_TRANSACTIONS (
...
CREATE TABLE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.RAW.RAW_PRODUCT_VIEWS (
...
CREATE TABLE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.RAW.RAW_PRODUCT_REVIEWS (
...
CREATE TABLE IF NOT EXISTS WESFARMERS_HEALTH_RECOMMENDER.RAW.RAW_MEMBER_INTERACTIONS (
